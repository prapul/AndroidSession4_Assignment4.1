package com.spambox.payal.androidsession4_assignment41;
...
public class MainActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        basc = (Button) findViewById(R.id.asc_button);
        bdes = (Button) findViewById(R.id.desc_button);
        months = (ListView) findViewById(R.id.name_list);
        ...
        months.setAdapter(stringAdapter);

        basc.setOnClickListener(this);
        bdes.setOnClickListener(this);
